...
.defines(function () {
    ...
    ig.Entity = ig.Class.extend({
        ...
        interpolate_diff: { x: 0, y: 0, angle: 0 },
        ...
        update: function () {
            ...
            this.accel.y += this.gravity * ig.system.tick * this.gravityFactor;

            this.vel.x = this.getNewVelocity(this.vel.x, this.accel.x, this.friction.x, this.maxVel.x);
            this.vel.y = this.getNewVelocity(this.vel.y, this.accel.y, this.friction.y, this.maxVel.y);

            var ground = this.ground || ig.game.groundheight;
            this.handleMovementTrace(ig.game.groundcollision(this.pos.x, this.pos.y, this.vel.x * ig.system.tick, this.vel.y * ig.system.tick, this.size.x, this.size.y, ground));
        ...
        destructionAnim: function (fire) {
            if (fire){
                return new ig.Animation(new ig.AnimationSheet('media/Objects/explosion.png', 320, 320), 0.03, [0, 1, 2, 3, 4, 5, 6], true);
            } else {
                return new ig.Animation(new ig.AnimationSheet('media/Objects/destruction.png', 320, 320), 0.03, [0, 1, 2, 3, 4, 5, 6], true);
    ...
    ig.Entity.checkPair = function (a, b) {
        ...
        if (!currentCollision) { return; }  //dont check agaisnt each other, dont solve the collision
